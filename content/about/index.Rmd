...
I'm looking for data analyst and data scientist jobs. Looking forward to hearing from you if you have any questions or suggestions.
...
So how can we learn from data? As an enthusiast of data science, I am motivated by the belief that data can be used to make better decisions. I am interested in exploring various facets of data science. Now I am focus on maching learning and information visualization to augment my professional experience. I will keep learning and practicing in the future, using data to inform decisions that positively affect user experience for companies. 

...
knitr::include_graphics("/projects/mobileappmarketanalysis/output_3_0.png")
```
...
```{r  echo = FALSE, out.width = "80%"}
knitr::include_graphics("/projects/mobileappmarketanalysis/output_6_0.png")

```
```{r  echo = FALSE, out.width = "80%"}
knitr::include_graphics("/projects/mobileappmarketanalysis/output_7_0.png")
```
...
knitr::include_graphics("/projects/mobileappmarketanalysis/output_23_0.png")
```
...
knitr::include_graphics("/projects/mobileappmarketanalysis/output_27_0.png")
```
...
```{r, echo=FALSE, out.width = "80%"}
#htmltools::includeHTML("/projects/mobileappmarketanalysis/good_rev.html")
#htmltools::tags$iframe(src = '/projects/mobileappmarketanalysis/good_rev.html', width = '100%', height = '...')
```
```{r  echo = FALSE, out.width = "80%"}
knitr::include_graphics("/projects/mobileappmarketanalysis/good.png")
```

```{r, echo=FALSE, out.width = "80%"}
#htmltools::includeHTML("/projects/mobileappmarketanalysis/bad_rev.html")
```
```{r  echo = FALSE, out.width = "80%"}
knitr::include_graphics("/projects/mobileappmarketanalysis/bad.png")
```
...
```{r, echo=FALSE, out.width = "80%"}
#htmltools::includeHTML("/projects/mobileappmarketanalysis/improved_apps.html")
```

The topic modeling visualization for low-rated apps is showed below: 

```{r, echo=FALSE, out.width = "80%"}
#htmltools::includeHTML("/projects/mobileappmarketanalysis/worsen_apps.html")
```
...
knitr::include_graphics("/projects/mobileappmarketanalysis/output_42_0.png")
```

```{r  echo = FALSE, out.width = "80%"}
knitr::include_graphics("/projects/mobileappmarketanalysis/output_43_0.png")
```
